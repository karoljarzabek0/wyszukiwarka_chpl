...
def search_similar(cur, query_text, top_k=5):
    ...
    if True:
        cur.execute(
            ...
            GROUP BY COALESCE(f.id_produktu, v.id_produktu), t.nazwa_produktu, t.kod_atc, t.nazwa_powszechna, f.fts_rank, v.vector_rank, v.id_fragmentu
...
results = search_similar(cur, "refluks", 50)
